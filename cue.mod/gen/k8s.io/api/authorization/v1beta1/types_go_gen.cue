...
#ResourceAttributes: {
	...
	// +optional
	fieldSelector?: null | authorizationv1.#FieldSelectorAttributes @go(FieldSelector,*authorizationv1.FieldSelectorAttributes) @protobuf(8,bytes,opt)

	// labelSelector describes the limitation on access based on labels.  It can only limit access, not broaden it.
	// +optional
	labelSelector?: null | authorizationv1.#LabelSelectorAttributes @go(LabelSelector,*authorizationv1.LabelSelectorAttributes) @protobuf(9,bytes,opt)
}
