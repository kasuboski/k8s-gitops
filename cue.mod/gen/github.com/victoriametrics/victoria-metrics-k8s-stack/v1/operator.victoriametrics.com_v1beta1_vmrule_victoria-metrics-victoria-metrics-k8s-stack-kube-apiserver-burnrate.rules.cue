...
vmrule: "victoria-metrics-victoria-metrics-k8s-stack-kube-apiserver-burnrate.rules": {
	...
	metadata: {
		...
		name:      "victoria-metrics-victoria-metrics-k8s-stack-kube-apiserver-burnrate.rules"
