...
vmrule: "victoria-metrics-victoria-metrics-k8s-stack-vmsingle": {
	...
	metadata: {
		...
		name:      "victoria-metrics-victoria-metrics-k8s-stack-vmsingle"
	...
	spec: groups: [{
		...
		rules: [{
			...
			annotations: {
				dashboard: "http://grafana.domain.com/d/wNf0q_kZk?viewPanel=53&var-instance={{ $labels.instance }}&var-cluster={{ $labels.cluster }}"
				description: """
			...
			annotations: {
				dashboard: "http://grafana.domain.com/d/oS7Bi_0Wz?viewPanel=53&var-instance={{ $labels.instance }}&var-cluster={{ $labels.cluster }}"
				description: """
			...
			annotations: {
				dashboard:   "http://grafana.domain.com/d/wNf0q_kZk?viewPanel=35&var-instance={{ $labels.instance }}&var-cluster={{ $labels.cluster }}"
			...
			annotations: {
				dashboard: "http://grafana.domain.com/d/wNf0q_kZk?viewPanel=66&var-instance={{ $labels.instance }}&var-cluster={{ $labels.cluster }}"
				description: """
			...
			annotations: {
				dashboard:   "http://grafana.domain.com/d/wNf0q_kZk?viewPanel=68&var-instance={{ $labels.instance }}&var-cluster={{ $labels.cluster }}"
