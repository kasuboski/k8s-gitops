...
vmrule: "vmks-victoria-metrics-k8s-stack-k8s.rules.containermemoryworkingsetbytes": {
	...
	metadata: {
		...
		name:      "vmks-victoria-metrics-k8s-stack-k8s.rules.containermemoryworkingsetbytes"
