...
vmrule: "victoria-metrics-victoria-metrics-k8s-stack-kubernetes-system-kubelet": {
	...
	metadata: {
		...
		name:      "victoria-metrics-victoria-metrics-k8s-stack-kubernetes-system-kubelet"
