...
configmap: "victoria-metrics-victoria-metrics-k8s-stack-node-exporter-full": {
	apiVersion: "v1"
	data: {
		"node-exporter-full.json": json.Marshal(_cue_node_exporter_full_json)
		let _cue_node_exporter_full_json = {"__requires": [{
			id:      "bargauge"
			name:    "Bar gauge"
			type:    "panel"
			version: ""
			...
			panels: [{
				...
				targets: [{
					editorMode:   "code"
					exemplar:     false
					expr:         "irate(node_pressure_cpu_waiting_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
					format:       "time_series"
					instant:      true
					legendFormat: "CPU"
					range:        false
					...
					editorMode:   "code"
					exemplar:     false
					expr:         "irate(node_pressure_memory_waiting_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
					format:       "time_series"
					instant:      true
					legendFormat: "Mem"
					range:        false
					...
					editorMode:   "code"
					exemplar:     false
					expr:         "irate(node_pressure_io_waiting_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
					format:       "time_series"
					instant:      true
					legendFormat: "I/O"
					range:        false
					...
					editorMode:   "code"
					exemplar:     false
					expr:         "irate(node_pressure_irq_stalled_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
					format:       "time_series"
					instant:      true
					legendFormat: "Irq"
					range:        false
				...
				targets: [{
					editorMode:   "code"
					exemplar:     false
					expr:         "100 * (1 - avg(rate(node_cpu_seconds_total{mode=\"idle\",instance=\"$node\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster))"
					instant:      true
					legendFormat: ""
					range:        false
					refId:        "A"
				...
				targets: [{
					editorMode: "code"
					exemplar:   false
					expr:       "(scalar(node_load1{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) * 100) / count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster)"
					format:     "time_series"
					instant:    true
					range:      false
					refId:      "A"
				...
				targets: [{
					editorMode: "code"
					exemplar:   false
					expr:       "clamp_min((1 - (node_memory_MemAvailable_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} / node_memory_MemTotal_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"})) * 100, 0)"
					format:     "time_series"
					instant:    true
					range:      false
					refId:      "B"
				...
				targets: [{
					editorMode: "code"
					exemplar:   false
					expr:       "((node_memory_SwapTotal_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} - node_memory_SwapFree_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) / node_memory_SwapTotal_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) * 100"
					instant:    true
					range:      false
					refId:      "A"
					step:       240
				...
				targets: [{
					editorMode: "code"
					exemplar:   false
					expr:       "((node_filesystem_size_bytes{instance=\"$node\",job=\"$job\",mountpoint=\"/\",fstype!=\"rootfs\",cluster=~\"$cluster\"} - node_filesystem_avail_bytes{instance=\"$node\",job=\"$job\",mountpoint=\"/\",fstype!=\"rootfs\",cluster=~\"$cluster\"}) / node_filesystem_size_bytes{instance=\"$node\",job=\"$job\",mountpoint=\"/\",fstype!=\"rootfs\",cluster=~\"$cluster\"}) * 100"
					format:     "time_series"
					instant:    true
					range:      false
					refId:      "A"
				...
				targets: [{
					editorMode:   "code"
					exemplar:     false
					expr:         "count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster)"
					instant:      true
					legendFormat: "__auto"
					range:        false
					refId:        "A"
				...
				targets: [{
					editorMode: "code"
					exemplar:   false
					expr:       "node_memory_MemTotal_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
					instant:    true
					range:      false
					refId:      "A"
					step:       240
				...
				targets: [{
					editorMode: "code"
					exemplar:   false
					expr:       "node_memory_SwapTotal_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
					instant:    true
					range:      false
					refId:      "A"
					step:       240
				...
				targets: [{
					editorMode: "code"
					exemplar:   false
					expr:       "node_filesystem_size_bytes{instance=\"$node\",job=\"$job\",mountpoint=\"/\",fstype!=\"rootfs\",cluster=~\"$cluster\"}"
					format:     "time_series"
					instant:    true
					range:      false
					refId:      "A"
				...
				targets: [{
					editorMode: "code"
					exemplar:   false
					expr:       "node_time_seconds{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} - node_boot_time_seconds{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
					instant:    true
					range:      false
					refId:      "A"
					step:       240
				...
				targets: [{
					editorMode:   "code"
					exemplar:     false
					expr:         "sum(irate(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",mode=\"system\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster) / scalar(count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster))"
					format:       "time_series"
					instant:      false
					...
					editorMode:   "code"
					expr:         "sum(irate(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",mode=\"user\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster) / scalar(count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster))"
					format:       "time_series"
					...
					editorMode:   "code"
					expr:         "sum(irate(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",mode=\"iowait\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster) / scalar(count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster))"
					format:       "time_series"
					...
					editorMode:   "code"
					expr:         "sum(irate(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",mode=~\".*irq\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster) / scalar(count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster))"
					format:       "time_series"
					...
					editorMode:   "code"
					expr:         "sum(irate(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",mode!=\"idle\",mode!=\"user\",mode!=\"system\",mode!=\"iowait\",mode!=\"irq\",mode!=\"softirq\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster) / scalar(count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster))"
					format:       "time_series"
					...
					editorMode:   "code"
					expr:         "sum(irate(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",mode=\"idle\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster) / scalar(count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster))"
					format:       "time_series"
					legendFormat: "Idle"
					range:        true
					refId:        "F"
				...
				targets: [{
					...
					editorMode:   "code"
					expr:         "(node_memory_MemTotal_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} - node_memory_MemFree_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) - ((node_memory_Cached_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} + node_memory_Buffers_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) + node_memory_SReclaimable_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"})"
					format:       "time_series"
					legendFormat: "Used"
					range:        true
					refId:        "B"
					...
					editorMode:   "code"
					expr:         "(node_memory_Cached_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} + node_memory_Buffers_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) + node_memory_SReclaimable_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
					format:       "time_series"
					...
					editorMode:   "code"
					expr:         "node_memory_MemFree_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
					format:       "time_series"
					legendFormat: "Free"
					range:        true
					refId:        "D"
					...
					editorMode:   "code"
					expr:         "node_memory_SwapTotal_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} - node_memory_SwapFree_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
					format:       "time_series"
				...
				targets: [{
					editorMode:   "code"
					expr:         "rate(node_network_receive_bytes_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval]) * 8"
					format:       "time_series"
					...
					editorMode:   "code"
					expr:         "rate(node_network_transmit_bytes_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval]) * 8"
					format:       "time_series"
				...
				targets: [{
					editorMode:   "code"
					expr:         "((node_filesystem_size_bytes{instance=\"$node\",job=\"$job\",device!~\"rootfs\",cluster=~\"$cluster\"} - node_filesystem_avail_bytes{instance=\"$node\",job=\"$job\",device!~\"rootfs\",cluster=~\"$cluster\"}) / node_filesystem_size_bytes{instance=\"$node\",job=\"$job\",device!~\"rootfs\",cluster=~\"$cluster\"}) * 100"
					format:       "time_series"
				...
				panels: [{
					...
					targets: [{
						editorMode:   "code"
						expr:         "sum(irate(node_cpu_seconds_total{mode=\"system\",instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster) / scalar(count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster))"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "sum(irate(node_cpu_seconds_total{mode=\"user\",instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster) / scalar(count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster))"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "sum(irate(node_cpu_seconds_total{mode=\"nice\",instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster) / scalar(count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster))"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "sum(irate(node_cpu_seconds_total{mode=\"iowait\",instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster) / scalar(count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster))"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "sum(irate(node_cpu_seconds_total{mode=\"irq\",instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster) / scalar(count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster))"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "sum(irate(node_cpu_seconds_total{mode=\"softirq\",instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster) / scalar(count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster))"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "sum(irate(node_cpu_seconds_total{mode=\"steal\",instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster) / scalar(count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster))"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "sum(irate(node_cpu_seconds_total{mode=\"idle\",instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster) / scalar(count(count(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cpu,cluster)) by(cluster))"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "(sum(irate(node_cpu_guest_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,cluster) / on(instance,cluster) group_left() sum(irate(node_cpu_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,cluster)) > 0"
						format:       "time_series"
					...
					targets: [{
						...
						editorMode:   "code"
						expr:         "node_memory_PageTables_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_SwapCached_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_Slab_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_Cached_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_Buffers_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_HardwareCorrupted_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "rate(node_network_receive_bytes_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval]) / ignoring(speed) node_network_speed_bytes{instance=\"$node\",job=\"$job\",speed!=\"-1\",cluster=~\"$cluster\"}"
						format:       "time_series"
						legendFormat: "{{device}} - Rx in"
						range:        true
						refId:        "A"
						...
						editorMode:   "code"
						expr:         "rate(node_network_transmit_bytes_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval]) / ignoring(speed) node_network_speed_bytes{instance=\"$node\",job=\"$job\",speed!=\"-1\",cluster=~\"$cluster\"}"
						format:       "time_series"
						legendFormat: "{{device}} - Tx out"
						range:        true
						refId:        "B"
					...
					targets: [{
						editorMode:   "code"
						expr:         "irate(node_disk_reads_completed_total{instance=\"$node\",job=\"$job\",device=~\"[a-z]+|nvme[0-9]+n[0-9]+|mmcblk[0-9]+\",cluster=~\"$cluster\"}[$__rate_interval])"
					...
					targets: [{
						...
						editorMode:   "code"
						expr:         "irate(node_disk_written_bytes_total{instance=\"$node\",job=\"$job\",device=~\"[a-z]+|nvme[0-9]+n[0-9]+|mmcblk[0-9]+\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						legendFormat: "{{device}} - Write"
						range:        true
						refId:        "B"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_filesystem_avail_bytes{instance=\"$node\",job=\"$job\",device!~\"rootfs\",cluster=~\"$cluster\"}"
						format:       "time_series"
						legendFormat: "{{mountpoint}}"
						metric:       ""
						range:        true
						...
						editorMode:   "code"
						expr:         "node_filesystem_free_bytes{instance=\"$node\",job=\"$job\",device!~\"rootfs\",cluster=~\"$cluster\"}"
						format:       "time_series"
						hide:         true
						...
						editorMode:   "code"
						expr:         "node_filesystem_size_bytes{instance=\"$node\",job=\"$job\",device!~\"rootfs\",cluster=~\"$cluster\"}"
						format:       "time_series"
						hide:         true
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_filesystem_size_bytes{instance=\"$node\",job=\"$job\",device!~\"rootfs\",cluster=~\"$cluster\"} - node_filesystem_avail_bytes{instance=\"$node\",job=\"$job\",device!~\"rootfs\",cluster=~\"$cluster\"}"
						format:       "time_series"
						legendFormat: "{{mountpoint}}"
						range:        true
						refId:        "A"
					...
					targets: [{
						...
						editorMode:   "code"
						expr:         "rate(node_pressure_memory_stalled_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "rate(node_pressure_irq_stalled_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
				...
				panels: [{
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_memory_Committed_AS_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_CommitLimit_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_memory_Writeback_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_WritebackTmp_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_Dirty_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_NFS_Unstable_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_memory_SUnreclaim_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_SReclaimable_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_memory_Mapped_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_Shmem_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_ShmemHugePages_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_memory_ShmemPmdMapped_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_memory_Inactive_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} / node_memory_MemTotal_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_Active_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} / node_memory_MemTotal_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_memory_Inactive_file_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_Inactive_anon_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_Active_file_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_Active_anon_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_memory_KernelStack_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_Percpu_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_memory_Bounce_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_memory_VmallocChunk_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_VmallocTotal_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_VmallocUsed_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_memory_AnonHugePages_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_AnonPages_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_memory_Unevictable_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_Mlocked_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_memory_DirectMap1G_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_DirectMap2M_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_memory_DirectMap4k_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_memory_HugePages_Free{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} * node_memory_Hugepagesize_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_HugePages_Rsvd{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} * node_memory_Hugepagesize_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_HugePages_Surp{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} * node_memory_Hugepagesize_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_memory_HugePages_Total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} * node_memory_Hugepagesize_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
				...
				panels: [{
					...
					targets: [{
						...
						editorMode:   "code"
						expr:         "irate(node_vmstat_pgfault{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval]) - irate(node_vmstat_pgmajfault{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
				...
				panels: [{
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_timex_estimated_error_seconds{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_timex_offset_seconds{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_timex_maxerror_seconds{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_timex_loop_time_constant{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_timex_sync_status{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_timex_frequency_adjustment_ratio{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_timex_tick_seconds{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						hide:         true
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_timex_tai_offset_seconds{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						hide:         true
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_timex_pps_frequency_hertz{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_timex_pps_stability_hertz{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_timex_pps_jitter_seconds{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_timex_pps_shift_seconds{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						...
						editorMode:   "code"
						expr:         "irate(node_timex_pps_stability_exceeded_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						interval:     ""
				...
				panels: [{
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_procs_blocked{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_procs_running{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_processes_state{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						legendFormat: "{{ state }}"
						range:        true
					...
					targets: [{
						editorMode:   "code"
						expr:         "irate(node_forks_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "irate(node_schedstat_running_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						hide:         true
						interval:     ""
						...
						editorMode:   "code"
						expr:         "irate(node_schedstat_waiting_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval]) / (irate(node_schedstat_running_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval]) + irate(node_schedstat_waiting_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval]))"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_processes_pids{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_processes_max_processes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_processes_threads{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_processes_max_threads{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
				...
				panels: [{
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_load1{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_load5{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_load15{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_cpu_scaling_frequency_hertz{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						legendFormat: "CPU {{ cpu }}"
						range:        true
						...
						editorMode:   "code"
						expr:         "avg(node_cpu_scaling_frequency_max_hertz{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cluster)"
						format:       "time_series"
						interval:     ""
						legendFormat: "Max"
						range:        true
						...
						editorMode:   "code"
						expr:         "avg(node_cpu_scaling_frequency_min_hertz{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) by(cluster)"
						format:       "time_series"
						interval:     ""
						legendFormat: "Min"
						range:        true
					...
					targets: [{
						editorMode:   "code"
						expr:         "irate(node_interrupts_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_entropy_available_bits{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_entropy_pool_size_bits{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
				...
				panels: [{
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_hwmon_temp_celsius{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} * on(chip,cluster) group_left(chip_name) node_hwmon_chip_names{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						expr:         "node_hwmon_temp_crit_alarm_celsius{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} * on(chip,cluster) group_left(chip_name) node_hwmon_chip_names{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						hide:         true
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_hwmon_temp_crit_celsius{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} * on(chip,cluster) group_left(chip_name) node_hwmon_chip_names{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						expr:         "node_hwmon_temp_crit_hyst_celsius{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} * on(chip,cluster) group_left(chip_name) node_hwmon_chip_names{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						hide:         true
						interval:     ""
						...
						expr:         "node_hwmon_temp_max_celsius{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} * on(chip,cluster) group_left(chip_name) node_hwmon_chip_names{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						hide:         true
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "(100 * node_cooling_device_cur_state{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}) / node_cooling_device_max_state{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_power_supply_online{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_hwmon_fan_rpm{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} * on(chip,cluster) group_left(chip_name) node_hwmon_chip_names{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						legendFormat: "{{ chip_name }} {{ sensor }}"
						range:        true
						...
						editorMode:   "code"
						expr:         "node_hwmon_fan_min_rpm{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} * on(chip,cluster) group_left(chip_name) node_hwmon_chip_names{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						hide:         true
						interval:     ""
				...
				panels: [{
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_systemd_units{instance=\"$node\",job=\"$job\",state=\"activating\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_systemd_units{instance=\"$node\",job=\"$job\",state=\"active\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						legendFormat: "Active"
						range:        true
						...
						editorMode:   "code"
						expr:         "node_systemd_units{instance=\"$node\",job=\"$job\",state=\"deactivating\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_systemd_units{instance=\"$node\",job=\"$job\",state=\"failed\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						legendFormat: "Failed"
						range:        true
						...
						editorMode:   "code"
						expr:         "node_systemd_units{instance=\"$node\",job=\"$job\",state=\"inactive\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_systemd_socket_current_connections{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						legendFormat: "{{ name }}"
						range:        true
					...
					targets: [{
						editorMode:   "code"
						expr:         "irate(node_systemd_socket_accepted_connections_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						interval:     ""
						legendFormat: "{{ name }}"
						range:        true
				...
				panels: [{
					...
					targets: [{
						editorMode:   "code"
						expr:         "irate(node_disk_reads_completed_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						legendFormat: "{{device}} - Read"
						range:        true
						refId:        "A"
						step:         240
					...
					targets: [{
						...
						editorMode:   "code"
						exemplar:     false
						expr:         "irate(node_disk_written_bytes_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						instant:      false
						legendFormat: "{{device}} - Write"
						range:        true
					...
					targets: [{
						editorMode:   "code"
						expr:         "irate(node_disk_read_time_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval]) / irate(node_disk_reads_completed_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						interval:     ""
						legendFormat: "{{device}} - Read"
						range:        true
						refId:        "A"
						...
						editorMode:   "code"
						expr:         "irate(node_disk_write_time_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval]) / irate(node_disk_writes_completed_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						interval:     ""
						legendFormat: "{{device}} - Write"
						range:        true
						refId:        "B"
					...
					targets: [{
						editorMode:   "code"
						expr:         "irate(node_disk_reads_merged_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						legendFormat: "{{device}} - Read"
						range:        true
						refId:        "A"
						step:         240
					...
					targets: [{
						...
						editorMode:   "code"
						expr:         "irate(node_disk_discard_time_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "irate(node_disk_flush_requests_time_seconds_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "irate(node_disk_discarded_sectors_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						interval:     ""
						legendFormat: "{{device}}"
						range:        true
						refId:        "A"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_disk_io_now{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						interval:     ""
						legendFormat: "{{device}}"
						range:        true
						refId:        "A"
				...
				panels: [{
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_filefd_maximum{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_filefd_allocated{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_filesystem_files_free{instance=\"$node\",job=\"$job\",device!~\"rootfs\",cluster=~\"$cluster\"}"
						format:       "time_series"
						legendFormat: "{{mountpoint}}"
						range:        true
						refId:        "A"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_filesystem_readonly{instance=\"$node\",job=\"$job\",device!~\"rootfs\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_filesystem_device_error{instance=\"$node\",job=\"$job\",device!~\"rootfs\",fstype!~\"tmpfs\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_filesystem_files{instance=\"$node\",job=\"$job\",device!~\"rootfs\",cluster=~\"$cluster\"}"
						format:       "time_series"
						legendFormat: "{{mountpoint}}"
						range:        true
						refId:        "A"
				...
				panels: [{
					...
					targets: [{
						...
						editorMode:   "code"
						expr:         "rate(node_network_transmit_packets_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						interval:     ""
						legendFormat: "{{device}} - Tx out"
						range:        true
					...
					targets: [{
						editorMode:   "code"
						expr:         "rate(node_network_receive_compressed_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						legendFormat: "{{device}} - Rx in"
						range:        true
						refId:        "A"
					...
					targets: [{
						...
						editorMode:   "code"
						expr:         "rate(node_network_transmit_fifo_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						legendFormat: "{{device}} - Tx out"
						range:        true
						refId:        "B"
					...
					targets: [{
						editorMode:   "code"
						expr:         "rate(node_network_transmit_carrier_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						legendFormat: "{{device}} - Tx out"
						range:        true
						refId:        "A"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_arp_entries{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_nf_conntrack_entries{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						...
						editorMode:   "code"
						expr:         "node_nf_conntrack_entries_limit{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_network_up{operstate=\"up\",instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						hide:         true
						...
						editorMode:   "code"
						expr:         "node_network_carrier{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						instant:      false
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_network_speed_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} * 8"
						format:       "time_series"
						legendFormat: "{{ device }}"
						range:        true
						refId:        "A"
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_network_mtu_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						legendFormat: "{{ device }}"
						range:        true
						refId:        "A"
				...
				panels: [{
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_sockstat_TCP_alloc{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_sockstat_TCP_inuse{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_sockstat_TCP_orphan{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_sockstat_TCP_tw{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_sockstat_UDPLITE_inuse{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_sockstat_UDP_inuse{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_sockstat_sockets_used{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_sockstat_FRAG_inuse{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_sockstat_RAW_inuse{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_sockstat_TCP_mem_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						legendFormat: "TCP"
						range:        true
						...
						editorMode:   "code"
						expr:         "node_sockstat_UDP_mem_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						legendFormat: "UDP"
						range:        true
						...
						editorMode:   "code"
						expr:         "node_sockstat_FRAG_memory{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_sockstat_TCP_mem_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} / node_sockstat_TCP_inuse{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						legendFormat: "TCP"
						range:        true
						...
						editorMode:   "code"
						expr:         "node_sockstat_UDP_mem_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"} / node_sockstat_UDP_inuse{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						legendFormat: "UDP"
						range:        true
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_sockstat_TCP_mem{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						legendFormat: "TCP"
						range:        true
						...
						editorMode:   "code"
						expr:         "node_sockstat_UDP_mem{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						legendFormat: "UDP"
						range:        true
					...
					targets: [{
						editorMode:   "code"
						expr:         "irate(node_softnet_processed_total{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						interval:     ""
				...
				panels: [{
					...
					targets: [{
						...
						editorMode:   "code"
						expr:         "irate(node_netstat_Tcp_OutSegs{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "irate(node_netstat_Udp_InDatagrams{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "irate(node_netstat_Udp_OutDatagrams{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						...
						editorMode:   "code"
						expr:         "irate(node_netstat_Tcp_RetransSegs{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "irate(node_netstat_Tcp_OutRsts{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "irate(node_netstat_TcpExt_TCPRcvQDrop{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "irate(node_netstat_TcpExt_TCPOFOQueue{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						interval:     ""
					...
					targets: [{
						...
						editorMode:   "code"
						expr:         "irate(node_netstat_Udp_SndbufErrors{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "irate(node_netstat_Icmp_InErrors{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}[$__rate_interval])"
						format:       "time_series"
						interval:     ""
						legendFormat: "ICMP Rx In"
						range:        true
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_netstat_Tcp_CurrEstab{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_netstat_Tcp_MaxConn{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_udp_queues{instance=\"$node\",job=\"$job\",ip=\"v4\",queue=\"rx\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_udp_queues{instance=\"$node\",job=\"$job\",ip=\"v4\",queue=\"tx\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_tcp_connection_states{state=\"established\",instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_tcp_connection_states{state=\"fin_wait2\",instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_tcp_connection_states{state=\"listen\",instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						legendFormat: "Listen"
						range:        true
						...
						editorMode:   "code"
						expr:         "node_tcp_connection_states{state=\"time_wait\",instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "node_tcp_connection_states{state=\"close_wait\",instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
				...
				panels: [{
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_scrape_collector_duration_seconds{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "process_virtual_memory_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "process_virtual_memory_max_bytes{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "process_max_fds{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "process_open_fds{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						interval:     ""
					...
					targets: [{
						editorMode:   "code"
						expr:         "node_scrape_collector_success{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
						legendFormat: "{{collector}}"
						range:        true
						...
						editorMode:   "code"
						expr:         "1 - node_textfile_scrape_error{instance=\"$node\",job=\"$job\",cluster=~\"$cluster\"}"
						format:       "time_series"
						interval:     ""
			...
			templating: list: [{
				...
				definition: "label_values(node_uname_info{job=\"$job\",nodename=\"$nodename\",cluster=~\"$cluster\"}, instance)"
				label:      "Instance"
				name:       "node"
				options: []
				query: {
					query: "label_values(node_uname_info{job=\"$job\",nodename=\"$nodename\",cluster=~\"$cluster\"}, instance)"
	...
	metadata: {
		...
		name:      "victoria-metrics-victoria-metrics-k8s-stack-node-exporter-full"
