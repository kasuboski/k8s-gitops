...
vmrule: "victoria-metrics-victoria-metrics-k8s-stack-kubernetes-system-apiserver": {
	...
	metadata: {
		...
		name:      "victoria-metrics-victoria-metrics-k8s-stack-kubernetes-system-apiserver"
