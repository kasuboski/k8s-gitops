...
vmrule: "victoria-metrics-victoria-metrics-k8s-stack-k8s.rules.containermemorycache": {
	...
	metadata: {
		...
		name:      "victoria-metrics-victoria-metrics-k8s-stack-k8s.rules.containermemorycache"
