...
configmap: "victoria-metrics-victoria-metrics-k8s-stack-victoriametrics-single-node": {
	apiVersion: "v1"
	data: {
		"victoriametrics-single-node.json": json.Marshal(_cue_victoriametrics_single_node_json)
		let _cue_victoriametrics_single_node_json = {
			annotations: list: [{
				builtIn: 1
				datasource: {
					type: "datasource"
				...
				enable:      false
				expr:        "sum(ALERTS{job=~\"$job\",instance=~\"$instance\",alertgroup=\"vmsingle\",alertstate=\"firing\",show_at=\"dashboard\",cluster=~\"$cluster\"}) by(alertname,cluster)"
				hide:        false
				iconColor:   "red"
				name:        "alerts"
				...
				enable:      true
				expr:        "sum(vm_app_version{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(version,cluster) unless sum(vm_app_version{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"} offset $__interval) by(version,cluster)"
				hide:        true
				iconColor:   "dark-blue"
				name:        "version"
				textFormat:  "{{version}}"
			...
			panels: [{
				...
				targets: [{
					...
					editorMode:     "code"
					exemplar:       false
					expr:           "sum(vm_rows{job=~\"$job\",instance=~\"$instance\",type!~\"indexdb.*\",cluster=~\"$cluster\"}) by(cluster)"
					format:         "time_series"
					instant:        true
					interval:       ""
					intervalFactor: 1
				...
				targets: [{
					...
					editorMode:     "code"
					exemplar:       false
					expr:           "sum(rate(vm_rows_inserted_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster)"
					format:         "time_series"
					instant:        true
					interval:       ""
					intervalFactor: 1
				...
				targets: [{
					...
					editorMode:     "code"
					exemplar:       false
					expr:           "sum(rate(vm_http_requests_total{job=~\"$job\",instance=~\"$instance\",path!~\".*(/write|/metrics)\",cluster=~\"$cluster\"}[$__rate_interval])) by(cluster)"
					format:         "time_series"
					instant:        true
					interval:       ""
					intervalFactor: 1
				...
				targets: [{
					...
					editorMode:   "code"
					exemplar:     false
					expr:         "min(vm_app_uptime_seconds{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(cluster)"
					instant:      true
					interval:     ""
					legendFormat: ""
					refId:        "A"
				...
				targets: [{
					...
					editorMode:     "code"
					exemplar:       false
					expr:           "sum(vm_cache_entries{job=~\"$job\",instance=~\"$instance\",type=\"storage/hour_metric_ids\",cluster=~\"$cluster\"}) by(cluster)"
					format:         "time_series"
					instant:        true
					interval:       ""
					intervalFactor: 1
				...
				targets: [{
					...
					editorMode:     "code"
					exemplar:       false
					expr:           "sum(vm_data_size_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(cluster)"
					format:         "time_series"
					instant:        true
					interval:       ""
					intervalFactor: 1
				...
				targets: [{
					...
					editorMode:     "code"
					exemplar:       false
					expr:           "max(sum(vm_data_size_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(cluster) / sum(vm_rows{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(cluster)) by(cluster)"
					format:         "time_series"
					instant:        true
					interval:       ""
					intervalFactor: 1
				...
				targets: [{
					datasource: uid: "$ds"
					editorMode:     "code"
					expr:           "sum(rate(vm_rows_inserted_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(type,instance,cluster) > 0"
					format:         "time_series"
					hide:           false
					intervalFactor: 1
				...
				targets: [{
					...
					editorMode:     "code"
					expr:           "sum(rate(vm_http_requests_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(path,instance,cluster) > 0"
					format:         "time_series"
					interval:       ""
					intervalFactor: 1
				...
				targets: [{
					...
					editorMode:     "code"
					expr:           "vm_cache_entries{job=~\"$job\",instance=~\"$instance\",type=\"storage/hour_metric_ids\",cluster=~\"$cluster\"}"
					format:         "time_series"
					intervalFactor: 1
				...
				targets: [{
					...
					editorMode:     "code"
					expr:           "max(vm_request_duration_seconds{job=~\"$job\",instance=~\"$instance\",quantile=\"0.99\",cluster=~\"$cluster\"}) by(instance,path,cluster) > 0"
					format:         "time_series"
					intervalFactor: 1
					legendFormat:   "{{instance}} - {{path}}"
					range:          true
				...
				targets: [{
					...
					editorMode:     "code"
					exemplar:       false
					expr:           "sum(rate(vm_http_request_errors_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,path,cluster) > 0"
					format:         "time_series"
					interval:       ""
					intervalFactor: 1
					legendFormat:   "{{instance}} - {{path}}"
				...
				targets: [{
					...
					editorMode:   "code"
					expr:         "sum(rate(vm_log_messages_total{job=~\"$job\",instance=~\"$instance\",level!=\"info\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,level,location,cluster) > 0"
					interval:     "5m"
				...
				panels: [{
					...
					targets: [{
						...
						editorMode:   "code"
						exemplar:     false
						expr:         "max(max_over_time(process_resident_memory_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval]) / vm_available_memory_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,cluster)"
						interval:     ""
						legendFormat: "__auto"
						range:        true
						refId:        "A"
					...
					targets: [{
						...
						editorMode:     "code"
						exemplar:       false
						expr:           "min(process_cpu_cores_available{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(cluster)"
						format:         "time_series"
						hide:           false
						interval:       ""
						intervalFactor: 1
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "sum(go_memstats_sys_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,cluster) + sum(vm_cache_size_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,cluster)"
						format:         "time_series"
						hide:           false
						intervalFactor: 1
						...
						editorMode:     "code"
						expr:           "sum(go_memstats_heap_inuse_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,cluster) + sum(vm_cache_size_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,cluster)"
						format:         "time_series"
						hide:           false
						intervalFactor: 1
						...
						editorMode:     "code"
						expr:           "sum(go_memstats_stack_inuse_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,cluster)"
						format:         "time_series"
						hide:           false
						intervalFactor: 1
						...
						editorMode:     "code"
						expr:           "sum(process_resident_memory_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,cluster)"
						format:         "time_series"
						hide:           false
						interval:       ""
						intervalFactor: 1
						...
						editorMode:     "code"
						exemplar:       false
						expr:           "sum(process_resident_memory_anon_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,cluster)"
						format:         "time_series"
						hide:           false
						interval:       ""
						intervalFactor: 1
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "sum(rate(process_io_storage_read_bytes_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,cluster)"
						format:         "time_series"
						hide:           false
						interval:       ""
						intervalFactor: 1
						...
						editorMode:     "code"
						expr:           "sum(rate(process_io_storage_written_bytes_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,cluster)"
						format:         "time_series"
						hide:           false
						interval:       ""
						intervalFactor: 1
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "sum(go_goroutines{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,cluster)"
						format:         "time_series"
						intervalFactor: 2
						legendFormat:   "{{instance}}"
						range:          true
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "sum(rate(process_io_read_syscalls_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,cluster)"
						format:         "time_series"
						hide:           false
						interval:       ""
						intervalFactor: 1
						...
						editorMode:     "code"
						expr:           "sum(rate(process_io_write_syscalls_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,cluster)"
						format:         "time_series"
						hide:           false
						interval:       ""
						intervalFactor: 1
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "sum(process_num_threads{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,cluster)"
						format:         "time_series"
						intervalFactor: 2
						legendFormat:   "{{instance}}"
						range:          true
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "sum(rate(vm_tcplistener_accepts_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,cluster)"
						format:         "time_series"
						hide:           false
						intervalFactor: 1
						legendFormat:   "{{instance}}"
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "sum(vm_tcplistener_conns{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,cluster)"
						format:         "time_series"
						hide:           false
						intervalFactor: 1
						legendFormat:   "{{instance}}"
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "max_over_time(process_open_fds{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval]) / process_max_fds{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}"
						format:         "time_series"
						hide:           false
						interval:       ""
						intervalFactor: 2
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "max(rate(go_gc_cpu_seconds_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval]) / rate(process_cpu_seconds_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,cluster)"
						format:         "time_series"
						interval:       ""
						intervalFactor: 2
						legendFormat:   "__auto"
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "(sum(rate(vm_tcplistener_read_bytes_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(name,cluster) * 8) > 0"
						format:         "time_series"
						hide:           false
						intervalFactor: 1
						...
						editorMode:     "code"
						expr:           "(sum(rate(vm_tcplistener_written_bytes_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(name,cluster) * 8) > 0"
						format:         "time_series"
						hide:           false
						intervalFactor: 1
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "histogram_quantile(0.99, sum(rate(go_sched_latencies_seconds_bucket{job=~\"$job\",cluster=~\"$cluster\"}[$__rate_interval])) by(job,instance,le,cluster))"
						format:         "time_series"
						interval:       ""
						intervalFactor: 2
						legendFormat:   "__auto"
				...
				panels: [{
					...
					targets: [{
						...
						editorMode:   "code"
						expr:         "sum(rate(vm_new_timeseries_created_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,cluster)"
						interval:     ""
						...
						editorMode:   "code"
						expr:         "sum(increase(vm_new_timeseries_created_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[24h])) by(instance,cluster)"
						interval:     ""
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "max(rate(vm_slow_row_inserts_total{job=~\"$job\",cluster=~\"$cluster\"}[$__rate_interval]) / rate(vm_rows_added_to_storage_total{job=~\"$job\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,cluster)"
						format:         "time_series"
						hide:           false
						interval:       ""
						intervalFactor: 1
					...
					targets: [{
						...
						editorMode:     "code"
						exemplar:       false
						expr:           "sum(increase(vm_assisted_merges_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,type,cluster) > 0"
						format:         "time_series"
						interval:       "5m"
						intervalFactor: 1
						legendFormat:   "{{instance}} - {{type}}"
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "sum(rate(vm_slow_queries_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,cluster)"
						format:         "time_series"
						hide:           false
						intervalFactor: 1
						legendFormat:   "{{instance}}"
					...
					targets: [{
						...
						editorMode:   "code"
						exemplar:     false
						expr:         "vm_cache_size_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"} / vm_cache_size_max_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}"
						interval:     ""
						legendFormat: "{{instance}} - {{type}}"
						range:        true
						refId:        "A"
					...
					targets: [{
						...
						editorMode:     "code"
						exemplar:       false
						expr:           "(rate(vm_cache_misses_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval]) / rate(vm_cache_requests_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) > 0"
						format:         "time_series"
						hide:           false
						interval:       ""
						intervalFactor: 1
					...
					targets: [{
						...
						editorMode:   "code"
						exemplar:     true
						expr:         "sum(increase(vm_rows_ignored_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[1h])) by(instance,reason,cluster)"
						hide:         false
						interval:     ""
						...
						editorMode:   "code"
						expr:         "sum(increase(vm_relabel_metrics_dropped_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[1h])) by(instance,cluster)"
						hide:         false
						instant:      false
					...
					targets: [{
						...
						editorMode:     "code"
						exemplar:       true
						expr:           "sum(rate(vm_deduplicated_samples_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,type,cluster) > 0"
						format:         "time_series"
						interval:       ""
						intervalFactor: 1
						legendFormat:   "__auto"
				...
				panels: [{
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "sum(rate(vm_rows_inserted_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,type,cluster) > 0"
						format:         "time_series"
						hide:           false
						intervalFactor: 1
						legendFormat:   "{{instance}} - {{type}}"
					...
					targets: [{
						...
						expr:           "vm_pending_rows{job=~\"$job\",instance=~\"$instance\",type=\"storage\",cluster=~\"$cluster\"}"
						format:         "time_series"
						hide:           false
						intervalFactor: 1
						...
						expr:           "vm_pending_rows{job=~\"$job\",instance=~\"$instance\",type=\"indexdb\",cluster=~\"$cluster\"}"
						format:         "time_series"
						hide:           false
						intervalFactor: 1
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "sum(vm_data_size_bytes{job=~\"$job\",instance=~\"$instance\",type!~\"indexdb.*\",cluster=~\"$cluster\"}) by(instance,cluster)"
						format:         "time_series"
						interval:       ""
						intervalFactor: 1
						...
						expr:           "vm_free_disk_space_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"} - vm_free_disk_space_limit_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}"
						format:         "time_series"
						interval:       ""
						intervalFactor: 1
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "sum(vm_parts{job=~\"$job\",instance=~\"$instance\",type=~\"indexdb.*\",cluster=~\"$cluster\"}) by(instance,type,cluster)"
						format:         "time_series"
						intervalFactor: 1
						legendFormat:   "{{instance}} - {{type}}"
						range:          true
						...
						editorMode:     "code"
						expr:           "max(vm_last_partition_parts{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,type,cluster)"
						format:         "time_series"
						hide:           false
						intervalFactor: 1
						legendFormat:   "{{instance}} - {{type}}"
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "sum(vm_rows{job=~\"$job\",instance=~\"$instance\",type!~\"indexdb.*\",cluster=~\"$cluster\"}) by(instance,cluster)"
						format:         "time_series"
						interval:       ""
						intervalFactor: 1
						...
						editorMode:     "code"
						expr:           "sum(vm_data_size_bytes{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,cluster) / sum(vm_rows{job=~\"$job\",instance=~\"$instance\",type!~\"indexdb.*\",cluster=~\"$cluster\"}) by(instance,cluster)"
						format:         "time_series"
						interval:       ""
						intervalFactor: 1
					...
					targets: [{
						...
						editorMode:   "code"
						expr:         "sum(vm_active_merges{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,type,cluster)"
						legendFormat: "{{instance}} - {{type}}"
						range:        true
						refId:        "A"
					}]
					...
					targets: [{
						...
						editorMode:   "code"
						expr:         "sum(rate(vm_rows_merged_total{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,type,cluster)"
						legendFormat: "{{instance}} - {{type}}"
						range:        true
						refId:        "A"
					}]
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "sum(vm_concurrent_insert_current{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}) by(instance,cluster)"
						format:         "time_series"
						intervalFactor: 1
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "histogram_quantile(0.99, sum(rate(vm_rows_read_per_series_bucket{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,vmrange,cluster))"
						format:         "time_series"
						interval:       ""
						intervalFactor: 1
						legendFormat:   "{{instance}}"
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "histogram_quantile(0.99, sum(rate(vm_series_read_per_query_bucket{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,vmrange,cluster))"
						format:         "time_series"
						interval:       ""
						intervalFactor: 1
						legendFormat:   "{{instance}}"
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "histogram_quantile(0.99, sum(rate(vm_rows_scanned_per_query_bucket{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,vmrange,cluster))"
						format:         "time_series"
						interval:       ""
						intervalFactor: 1
						legendFormat:   "{{instance}}"
					...
					targets: [{
						...
						editorMode:     "code"
						expr:           "histogram_quantile(0.99, sum(rate(vm_rows_read_per_query_bucket{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}[$__rate_interval])) by(instance,vmrange,cluster))"
						format:         "time_series"
						interval:       ""
						intervalFactor: 1
						legendFormat:   "{{instance}}"
					...
					targets: [{
						...
						editorMode:   "code"
						exemplar:     true
						expr:         "vm_snapshots{job=~\"$job\",instance=~\"$instance\",cluster=~\"$cluster\"}"
						interval:     ""
						legendFormat: "{{instance}}"
						range:        true
						refId:        "A"
			...
			templating: list: [{
				...
				definition: "label_values(vm_app_version{version=~\"victoria-metrics-.*\",cluster=~\"$cluster\"}, job)"
				name:       "job"
				options: []
				query: {
					query: "label_values(vm_app_version{version=~\"victoria-metrics-.*\",cluster=~\"$cluster\"}, job)"
	...
	metadata: {
		...
		name:      "victoria-metrics-victoria-metrics-k8s-stack-victoriametrics-single-node"
