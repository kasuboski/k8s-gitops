...
vmrule: "victoria-metrics-victoria-metrics-k8s-stack-k8s.rules.containercpuusagesecondstotal": {
	...
	metadata: {
		...
		name:      "victoria-metrics-victoria-metrics-k8s-stack-k8s.rules.containercpuusagesecondstotal"
