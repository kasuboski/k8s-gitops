...
customresourcedefinition: "vtclusters.operator.victoriametrics.com": {
	...
	"""
								properties: {
									disableInsertBalancing: type: "boolean"
									disableSelectBalancing: type: "boolean"
	...
	"""
									...
									extraStorageNodes: {
										...
										items: {
											description: "VTStorageNode defines slice of additional vtstorage nodes"
											properties: addr: {
