...
configmap: "longhorn-default-setting": {
	apiVersion: "v1"
	data: {
		"default-setting.yaml": yaml.Marshal(_cue_default_setting_yaml)
		let _cue_default_setting_yaml = {
			"priority-class":           "longhorn-critical"
			"disable-revision-counter": json.Marshal(_cue_disable_revision_counter)
			let _cue_disable_revision_counter = {
				v1: "true"
			}
		}, }
	kind: "ConfigMap"
...
configmap: "longhorn-storageclass": {
	apiVersion: "v1"
	data: {
		"storageclass.yaml": yaml.Marshal(_cue_storageclass_yaml)
		let _cue_storageclass_yaml = {
			kind:       "StorageClass"
...
customresourcedefinition: "backingimagemanagers.longhorn.io": {
	...
	"""
					...
					status: {
						...
						properties: {
							apiMinVersion: type: "integer"
							apiVersion: type: "integer"
							backingImageFileMap: {
								additionalProperties: {
									properties: {
										currentChecksum: type: "string"
										message: type: "string"
										name: type: "string"
										progress: type: "integer"
										realSize: {
										...
										senderManagerAddress: type: "string"
										sendingReference: type: "integer"
										size: {
											format: "int64"
											type:   "integer"
										}
	...
	"""
					...
					spec: {
						...
						properties: {
							...
							diskFileSpecMap: {
								additionalProperties: {
									properties: {
										...
										evictionRequested: type: "boolean"
									}
									type: "object"
								}
								type: "object"
							...
							minNumberOfCopies: type: "integer"
							nodeSelector: {
								items: type: "string"
								type: "array"
							}
							...
							diskFileStatusMap: {
								additionalProperties: {
									properties: {
										...
										lastStateTransitionTime: type: "string"
										message: type: "string"
										progress: type: "integer"
										state: type: "string"
									}
...
customresourcedefinition: "engineimages.longhorn.io": {
	...
	"""
					...
					status: {
						...
						properties: {
							...
							cliAPIMinVersion: type: "integer"
							cliAPIVersion: type: "integer"
							conditions: {
								items: {
									properties: {
										lastProbeTime: {
	...
	"""
							...
							controllerAPIMinVersion: type: "integer"
							controllerAPIVersion: type: "integer"
							dataFormatMinVersion: type: "integer"
							dataFormatVersion: type: "integer"
							gitCommit: type: "string"
							incompatible: type: "boolean"
							noRefSince: type: "string"
							nodeDeploymentMap: {
...
customresourcedefinition: "engines.longhorn.io": {
	...
	"""
					...
					spec: {
						...
						properties: {
							...
							desireState: type: "string"
							disableFrontend: type: "boolean"
							frontend: {
								enum: [
									"blockdev",
									"iscsi",
							...
							image: type: "string"
							logRequested: type: "boolean"
							nodeID: type: "string"
							replicaAddressMap: {
								additionalProperties: type: "string"
								type: "object"
							}
							requestedBackupRestore: type: "string"
							requestedDataSource: type: "string"
							revisionCounterDisabled: type: "boolean"
							salvageRequested: type: "boolean"
							snapshotMaxCount: type: "integer"
							snapshotMaxSize: {
								format: "int64"
								type:   "string"
							}
							unmapMarkSnapChainRemovedEnabled: type: "boolean"
						...
						properties: {
							...
							cloneStatus: {
								additionalProperties: {
									properties: {
										error: type: "string"
										fromReplicaAddress: type: "string"
	...
	"""
							...
							instanceManagerName: type: "string"
							ip: type: "string"
							isExpanding: type: "boolean"
							lastExpansionError: type: "string"
							lastExpansionFailedAt: type: "string"
							lastRestoredBackup: type: "string"
							logFetched: type: "boolean"
							ownerID: type: "string"
							port: type: "integer"
							purgeStatus: {
								additionalProperties: {
	...
	"""
							...
							restoreStatus: {
								additionalProperties: {
									properties: {
										backupURL: type: "string"
										currentRestoringBackup: type: "string"
										error: type: "string"
										filename: type: "string"
										isRestoring: type: "boolean"
										lastRestored: type: "string"
										progress: type: "integer"
										state: type: "string"
									}
									type: "object"
...
customresourcedefinition: "instancemanagers.longhorn.io": {
	...
	"""
					...
					spec: {
						...
						properties: {
							dataEngine: type: "string"
							dataEngineSpec: {
								properties: v2: {
									properties: cpuMask: type: "string"
									type: "object"
								}
								type: "object"
							}
	...
	"""
							...
							ip: type: "string"
							ownerID: type: "string"
							proxyApiMinVersion: type: "integer"
							proxyApiVersion: type: "integer"
						}
						type: "object"
					}
				}
...
customresourcedefinition: "nodes.longhorn.io": {
	...
	"""
					...
					spec: {
						...
						properties: {
							...
							evictionRequested: type: "boolean"
							instanceManagerCPURequest: type: "integer"
							name: type: "string"
							tags: {
								items: type: "string"
								type: "array"
	...
	"""
							...
							region: type: "string"
							snapshotCheckStatus: {
								properties: lastPeriodicCheckedAt: {
									format: "date-time"
									type:   "string"
								}
								type: "object"
...
customresourcedefinition: "replicas.longhorn.io": {
	...
	"""
					...
					spec: {
						...
						properties: {
							active: type: "boolean"
							backingImage: type: "string"
							dataDirectoryName: type: "string"
							dataEngine: {
								enum: [
									"v1",
									"v2",
	...
	"""
							...
							nodeID: type: "string"
							rebuildRetryCount: type: "integer"
							revisionCounterDisabled: type: "boolean"
							salvageRequested: type: "boolean"
							snapshotMaxCount: type: "integer"
							snapshotMaxSize: {
							...
							unmapMarkDiskChainRemovedEnabled: type: "boolean"
							volumeName: type: "string"
							volumeSize: {
								format: "int64"
								type:   "string"
...
customresourcedefinition: "volumeattachments.longhorn.io": {
	...
	"""
					...
					status: {
						...
						properties: attachmentTicketStatuses: {
							additionalProperties: {
								properties: {
									conditions: {
...
customresourcedefinition: "volumes.longhorn.io": {
	...
	"""
					...
					spec: {
						...
						properties: {
							...
							image: type: "string"
							lastAttachedBy: type: "string"
							migratable: type: "boolean"
							migrationNodeID: type: "string"
							nodeID: type: "string"
							nodeSelector: {
								items: type: "string"
								type: "array"
							}
							numberOfReplicas: type: "integer"
							offlineRebuilding: {
								description: """
	...
	"""
							...
							staleReplicaTimeout: type: "integer"
						...
						properties: {
							...
							cloneStatus: {
								properties: {
									...
									nextAllowedAttemptAt: type: "string"
	...
	"""
							...
							expansionRequired: type: "boolean"
							frontendDisabled: type: "boolean"
							isStandby: type: "boolean"
							kubernetesStatus: {
								properties: {
									lastPVCRefAt: type: "string"
									lastPodRefAt: type: "string"
									namespace: {
										description: "determine if PVC/Namespace is history or not"
										type:        "string"
									}
									pvName: type: "string"
									pvStatus: type: "string"
									pvcName: type: "string"
									workloadsStatus: {
							...
							lastDegradedAt: type: "string"
							ownerID: type: "string"
							remountRequestedAt: type: "string"
							restoreInitiated: type: "boolean"
							restoreRequired: type: "boolean"
							robustness: type: "string"
							shareEndpoint: type: "string"
...
service: "longhorn-recovery-backend": {
	...
	spec: {
		...
		selector: "longhorn.io/recovery-backend": "longhorn-recovery-backend"
		type: "ClusterIP"
	}
}
		...
		template: {
			...
			spec: {
				...
				volumes: [{
					...
					hostPath: path: "/var/lib/longhorn/"
					name: "longhorn"
				}, {
					name: "longhorn-grpc-tls"
					secret: {
...
deployment: "longhorn-driver-deployer": {
	...
	spec: {
		replicas: 1
		selector: matchLabels: app: "longhorn-driver-deployer"
		template: {
			metadata: labels: {
...
deployment: "longhorn-ui": {
	...
	spec: {
		replicas: 2
		selector: matchLabels: app: "longhorn-ui"
		template: {
			metadata: labels: {
				app:                          "longhorn-ui"
				"app.kubernetes.io/instance": "longhorn"
